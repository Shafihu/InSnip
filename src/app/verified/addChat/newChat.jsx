            ...
            <View style={{ paddingHorizontal: 15, backgroundColor: '#f5f5f5', flex: 1 }}>
                ...
                {loading ? (
                    ...
                    >
                        ...
                        <Pressable onPress={()=>{}} style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 5, backgroundColor: '#f5f5f5', borderRadius: '100%', paddingHorizontal: 20, paddingVertical: 5 }}>
