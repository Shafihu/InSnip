...
const UserProfile = () => {
    ...
    const loadCurrentUserStories = async (id) => {
        try {
          ...
          const currentUserStories = storiesWithUserDetails.filter((item) => item.userId === id);
      ...
      const loadCurrentUserSpotlights = async (id) => {
        try {
          ...
          const currentUserSpotlights = spotlightsWithUserDetails.filter((item) => item.userId === id);
            ...
            stories && stories.length > 0 ? (
              ...
              />
                ...
                <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                  <Text style={{textAlign: 'center', color: 'gray'}}>Stories from {firstname} will appear here.</Text>
                </View>
              )
            ) : (
              spotlights && spotlights.length > 0 ? (
                ...
                />
                    ...
                    <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                      <Text style={{textAlign: 'center', color: 'gray'}}>Spotlights from {firstname} will appear here.</Text>
                    </View>
                  )
              )}
                </>
